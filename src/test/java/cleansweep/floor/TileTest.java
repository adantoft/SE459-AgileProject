...
public class TileTest {
	...
	public void getFloorCodeAsStringTest() throws Exception {
		...
		assertNotSame(Floor.BARE.getFloorCodeAsString(),
				Floor.LOW.getFloorCodeAsString());
		assertNotSame(Floor.BARE.getFloorCodeAsString(),
				Floor.HIGH.getFloorCodeAsString());

		assertNotSame(Floor.LOW.getFloorCodeAsString(),
				Floor.BARE.getFloorCodeAsString());
		assertNotSame(Floor.LOW.getFloorCodeAsString(),
				Floor.HIGH.getFloorCodeAsString());

		assertNotSame(Floor.HIGH.getFloorCodeAsString(),
				Floor.LOW.getFloorCodeAsString());
		assertNotSame(Floor.HIGH.getFloorCodeAsString(),
				Floor.BARE.getFloorCodeAsString());
	...
	public void getAdjacentTest() throws Exception {
		...
		assertEquals("Dirt: 0" + "\nFloor type: Low pile", testTile1
				.getAdjacent(NORTH).toString());
