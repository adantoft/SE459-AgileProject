...
public class FloorPlanTest {
	...
	public void attachTilesTest() throws Exception {
		...
		assertNotEquals(testMapNew.getTiles().toString(), testMapNewCompare
				.getTiles().toString());
		...
		assertEquals(testMapNew.getTiles().toString(), testMapNewCompare2
				.getTiles().toString());
	...
	public void setSpaceTest() throws Exception {
		...
		FloorPlan testMapNewCompare = new FloorPlan(2, 2);
		Space testRoom1HighCarpNew = new Space(new Point(0, 0), new Point(1, 1));
		Space testRoom1HighCarpNew1 = new Space(new Point(0, 0),
				new Point(1, 1));
		...
		assertNotEquals(testMapNew.getTile(0, 0).toString(), testMapNewCompare
				.getTile(0, 0).toString());
		...
		assertEquals(testMapNew.getTile(0, 0).toString(), testMapNewCompare
				.getTile(0, 0).toString());
	...
	public void getTilesTest() throws Exception {
		...
		assertNotEquals(testMapNew.getTiles().toString(), testMapCompare
				.getTiles().toString());

		testMapCompare.setFloor(0, testRoom1HighCarpNew, Tile.Floor.HIGH);
		assertEquals(testMapNew.getTiles().toString(), testMapCompare
				.getTiles().toString());
	...
	public void getTileTest() throws Exception {
		...
		// is happening now.
		assertEquals("Dirt: 0\n" + "Floor type: High pile", testMapNewTest
				.getTile(0, 0).toString());
